...
typedef struct {
		...
		s32 pos_x; /* The x position of the image to display */
		s32 pos_y; /* The y position of the image to display */
		s32 shift_stride; /* The stride of shifting the frame */
		u32 img_width; /* The width of the img to display */
		u32 img_height; /* The height of the img to display */
} DisplayCtrl;
