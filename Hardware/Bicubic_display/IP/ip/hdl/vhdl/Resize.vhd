...
architecture behav of Resize is 
    ...
    signal p_dst_rows_V_read_reg_272 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal p_dst_cols_V_read_reg_277 : STD_LOGIC_VECTOR (12 downto 0);
    signal p_src_rows_V_read_reg_282 : STD_LOGIC_VECTOR (10 downto 0);
    signal p_src_cols_V_read_reg_287 : STD_LOGIC_VECTOR (10 downto 0);
    signal grp_Resize_opr_bicubic_fu_232_ap_start : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_ap_done : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_ap_idle : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_ap_ready : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_src_data_stream_0_V_read : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_src_data_stream_1_V_read : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_src_data_stream_2_V_read : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_0_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_0_V_write : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_write : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_din : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_write : STD_LOGIC;
    signal grp_Resize_opr_bicubic_fu_232_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_Resize_opr_bicubic_fu_232 : component Resize_opr_bicubic
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_Resize_opr_bicubic_fu_232_ap_start,
        ap_done => grp_Resize_opr_bicubic_fu_232_ap_done,
        ap_idle => grp_Resize_opr_bicubic_fu_232_ap_idle,
        ap_ready => grp_Resize_opr_bicubic_fu_232_ap_ready,
        p_src_rows_V_read => p_src_rows_V_read_reg_282,
        p_src_cols_V_read => p_src_cols_V_read_reg_287,
        p_src_data_stream_0_V_dout => p_src_data_stream_0_V_dout,
        p_src_data_stream_0_V_empty_n => p_src_data_stream_0_V_empty_n,
        p_src_data_stream_0_V_read => grp_Resize_opr_bicubic_fu_232_p_src_data_stream_0_V_read,
        p_src_data_stream_1_V_dout => p_src_data_stream_1_V_dout,
        p_src_data_stream_1_V_empty_n => p_src_data_stream_1_V_empty_n,
        p_src_data_stream_1_V_read => grp_Resize_opr_bicubic_fu_232_p_src_data_stream_1_V_read,
        p_src_data_stream_2_V_dout => p_src_data_stream_2_V_dout,
        p_src_data_stream_2_V_empty_n => p_src_data_stream_2_V_empty_n,
        p_src_data_stream_2_V_read => grp_Resize_opr_bicubic_fu_232_p_src_data_stream_2_V_read,
        p_dst_rows_V_read => p_dst_rows_V_read_reg_272,
        p_dst_cols_V_read => p_dst_cols_V_read_reg_277,
        p_dst_data_stream_0_V_din => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_0_V_din,
        p_dst_data_stream_0_V_full_n => p_dst_data_stream_0_V_full_n,
        p_dst_data_stream_0_V_write => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_0_V_write,
        p_dst_data_stream_1_V_din => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_din,
        p_dst_data_stream_1_V_full_n => p_dst_data_stream_1_V_full_n,
        p_dst_data_stream_1_V_write => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_write,
        p_dst_data_stream_2_V_din => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_din,
        p_dst_data_stream_2_V_full_n => p_dst_data_stream_2_V_full_n,
        p_dst_data_stream_2_V_write => grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_write);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_bicubic_fu_232_ap_done = ap_const_logic_1))) then 
    ...
    grp_Resize_opr_bicubic_fu_232_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_Resize_opr_bicubic_fu_232_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_Resize_opr_bicubic_fu_232_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_Resize_opr_bicubic_fu_232_ap_ready = ap_const_logic_1)) then 
                    grp_Resize_opr_bicubic_fu_232_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((p_dst_cols_V_out_full_n = ap_const_logic_0) or (p_dst_rows_V_out_full_n = ap_const_logic_0) or (real_start = ap_const_logic_0) or (p_dst_cols_V_empty_n = ap_const_logic_0) or (p_dst_rows_V_empty_n = ap_const_logic_0) or (p_src_cols_V_empty_n = ap_const_logic_0) or (p_src_rows_V_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_dst_cols_V_read_reg_277 <= p_dst_cols_V_dout;
                p_dst_rows_V_read_reg_272 <= p_dst_rows_V_dout;
                p_src_cols_V_read_reg_287 <= p_src_cols_V_dout;
                p_src_rows_V_read_reg_282 <= p_src_rows_V_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_V_empty_n, p_src_cols_V_empty_n, p_dst_rows_V_empty_n, p_dst_cols_V_empty_n, p_dst_rows_V_out_full_n, p_dst_cols_V_out_full_n, grp_Resize_opr_bicubic_fu_232_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_bicubic_fu_232_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_Resize_opr_bicubic_fu_232_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_bicubic_fu_232_ap_done = ap_const_logic_1))) then 
    ...
    grp_Resize_opr_bicubic_fu_232_ap_start <= grp_Resize_opr_bicubic_fu_232_ap_start_reg;

    internal_ap_ready_assign_proc : process(grp_Resize_opr_bicubic_fu_232_ap_done, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (grp_Resize_opr_bicubic_fu_232_ap_done = ap_const_logic_1))) then 
    ...
    p_dst_data_stream_0_V_write_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_0_V_write, ap_CS_fsm_state2)
    begin
    ...
    p_dst_data_stream_1_V_write_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_dst_data_stream_1_V_write <= grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_1_V_write;
        else 
    ...
    p_dst_data_stream_2_V_write_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_dst_data_stream_2_V_write <= grp_Resize_opr_bicubic_fu_232_p_dst_data_stream_2_V_write;
        else 
    ...
    p_src_data_stream_0_V_read_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_src_data_stream_0_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_stream_0_V_read <= grp_Resize_opr_bicubic_fu_232_p_src_data_stream_0_V_read;
        else 
    ...
    p_src_data_stream_1_V_read_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_src_data_stream_1_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_stream_1_V_read <= grp_Resize_opr_bicubic_fu_232_p_src_data_stream_1_V_read;
        else 
    ...
    p_src_data_stream_2_V_read_assign_proc : process(grp_Resize_opr_bicubic_fu_232_p_src_data_stream_2_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_stream_2_V_read <= grp_Resize_opr_bicubic_fu_232_p_src_data_stream_2_V_read;
        else 
