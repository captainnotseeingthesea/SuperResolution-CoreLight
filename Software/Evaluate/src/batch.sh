...
python3 upscale_batch.py -exe ../../zoom/app -src ../downscaled/ -dst ../upscaled/ -method 1
python3 upscale_batch.py -exe 'python upscale.py' -src ../downscaled/ -dst ../linear_upscaled/ -method 1

# Measure the quality of the upscaled images
python3 Measure.py -dirA ../GT/ -dirB ../LINEAR_upscaled/
