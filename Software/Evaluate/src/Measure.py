...
def measure_dirs(dirA, dirB, use_gpu, verbose=False):
    ...
    vprint(f'{"GT": ^5}, {"Res" : ^5}, {"psnr": ^5}, {"ssim": ^5}, {"lpips": ^5}, {"time" : ^3}')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluating the quality of the upscaled images with PSNR, PSNR, LPIPS")
    parser.add_argument('-dirA', default='', type=str, help="The path of the dir saving GroundTruth images")
    parser.add_argument('-dirB', default='', type=str, help="The path of the dir saving Upscaled images")
    parser.add_argument('-type', default='bmp', help="The type of the images to compare")
    parser.add_argument('--use_gpu', action='store_true', default=False, help="Whether to use GPU to compute lpips")
